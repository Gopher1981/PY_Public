...
ElseIf LabelSku <> "" Then
	ScreenType = Array("DT Price Menu Board SOC","DT PreSell 1 Left SOC","DT PreSell 1 Right SOC","DT Order COD 1 Left SOC","DT Order COD 1 Right SOC","DT Order COD 2 Left SOC","DT Order COD 2 Right SOC","DT Price Menu Board","DT PreSell 1 Left","DT PreSell 1 Right","DT Order COD 1 Left","DT Order COD 1 Right","DT Order COD 2 Left","DT Order COD 2 Right","DT Mini Screen 1")
	Dim Stypes, item, ip
